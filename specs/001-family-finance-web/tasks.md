...
- [ ] T145 [P] FamilyService CRUD operations in backend/src/services/family.service.ts
...
- [ ] T250 GET /api/reports/cash-flow endpoint in backend/src/api/reports/cash-flow.ts
